# -*- coding: utf-8 -*-
"""
Trust Trajectories Visualization for Splo
"""
...
def load_dynamics_data(data_path="./Data/ASG_dynamics_analysis/ASG_dynamics_solo.csv"):
    """Load the solo ASG dynamics data"""
...
def create_group_four_panel_plot(group_data, group_id, output_dir="./Data/visualization_trust_trajectories_solo"):
    """Create a 2x2 grid plot showing individual agent trajectories within a group"""
    
    # Create figure with 2x2 subplots
    fig, axes = plt.subplots(2, 2, figsize=(16, 12))
    fig.suptitle(f'SOLO Group {int(group_id)} Individual Agent Trust Trajectories', 
                 fontsize=16, fontweight='bold')
    
    # Use the global color palette (consistent across ALL groups)
...
def generate_all_group_four_panel_plots(dynamics_df, output_dir="./Data/trust_trajectories_solo"):
...
def main():
    ...
    output_dir = "./Data/trust_trajectories_solo"
